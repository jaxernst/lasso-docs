...
description: 'Eligibility, ranking and live admission in Core v0.4.5'
---

**Lasso RPC Core v0.4.5** selects upstream channels from the requested file profile
...
[file schema](https://github.com/jaxernst/lasso-rpc/blob/v0.4.5/lib/lasso/config/file_schema.ex)
and [configuration reference](https://github.com/jaxernst/lasso-rpc/blob/v0.4.5/docs/CONFIGURATION.md#provider-capabilities).
