...
Core checked September 20, 2026; Cloud checked September 23, 2026:
...
| Managed Cloud | Public health reported source `1a9c93ae18f855000a65a4b01854d482b0a224ea` in four regions at `2026-09-23T23:01:09Z` | A dated deployment observation. Recheck [health](https://lasso.sh/api/health) and [service discovery](https://lasso.sh/agent.json) for your evaluation. Process health does not qualify your workload. |
