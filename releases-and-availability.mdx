...
| --- | --- | --- |
| RPC Core source | [v0.4.3](https://github.com/jaxernst/lasso-rpc/releases/tag/v0.4.3), source `42415b421c1af2e5e582130e96ee0688f2b21fd0` | The released source described by the Core API guides. [Exact-source CI](https://github.com/jaxernst/lasso-rpc/actions/runs/35532589065) passed; repository main can be newer. |
| RPC Core container | v0.4.3, image index `sha256:52fea12de0a1a1eace455bbad07f54e2af71170c2962c34f5e50c3d55ee02d1e` | The [release manifest](https://github.com/jaxernst/lasso-rpc/releases/download/v0.4.3/container-release.json) binds source and image digests. Native AMD64 and ARM64 installation checks passed before [publication completed](https://github.com/jaxernst/lasso-rpc/actions/runs/35532937813). |
...
| Capability | RPC Core v0.4.3 | Managed Cloud | Qualification boundary |
| --- | --- | --- | --- |
...
The v0.4.3 [container verification summary](https://github.com/jaxernst/lasso-rpc/releases/download/v0.4.3/container-verification.md)
records 19 installation and recovery checks on each native
[AMD64](https://github.com/jaxernst/lasso-rpc/releases/download/v0.4.3/verification-amd64.json)
and [ARM64](https://github.com/jaxernst/lasso-rpc/releases/download/v0.4.3/verification-arm64.json)
...
The preceding [v0.4.2 container report](https://github.com/jaxernst/lasso-rpc/releases/download/v0.4.2/container-verification.md)
remains historical evidence for that earlier image.
