---
title: Operating block continuity
description: Configure the optional journal, serving fleet, and recovery procedures.
---
...
Read the [builder contract](/advanced/block-continuity) before enabling it. Global mode
...
## Local mode without a journal

For local monotonicity, set `head_policy: local` in each chain's file profile.
...
[the complete logical read](/advanced/read-at-one-block) through multiple instances.
