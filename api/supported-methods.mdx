...
description: The released RPC Core method, transaction, subscription, and affinity contract.
---

This page describes the self-hosted **v0.4.4** runtime. Lasso Cloud has a separate
...
RPC Core v0.4.4 can forward provider-local filter methods when capability policy
...
In Core v0.4.4, `subscribe_new_heads` controls automatic block monitoring **and**
