...
This page describes the self-hosted **v0.4.3** runtime. Lasso Cloud has a separate
...
RPC Core v0.4.3 can forward provider-local filter methods when capability policy
...
In Core v0.4.3, `subscribe_new_heads` controls automatic block monitoring **and**
