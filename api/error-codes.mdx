...
Core v0.4.3 can forward provider-local filter methods when capability policy
...
Released Core v0.4.3 returns routing exhaustion as a JSON-RPC `-32000` error over
...
The shape matches the released [controller regression](https://github.com/jaxernst/lasso-rpc/blob/v0.4.3/test/lasso_web/controllers/rpc_controller_test.exs)
and [error contract](https://github.com/jaxernst/lasso-rpc/blob/v0.4.3/docs/API_REFERENCE.md#error-responses).
