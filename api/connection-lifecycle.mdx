...
The connection can close when you disconnect, fail to answer heartbeats, lose profile access, encounter a network interruption, or the server restarts. Subscription continuity exhaustion can also close the connection.
...
Two application-level closure cases have explicit heartbeat or continuity meaning:
