...
description: 'JSON-RPC envelopes and released Core v0.4.3 metadata'
---

**Lasso RPC Core v0.4.3** returns JSON-RPC responses. Metadata is optional.
...
extensions. These fields describe Core v0.4.3, not a Cloud quota or billing schema.
