...
- Agent-managed keys can buy prepaid premium credit with USDC over Tempo MPP or
  Base x402, capped per quote. Stripe-backed account billing is separate. Legacy
