...
| --- | --- |
| Anonymous key | Method-based cost, adjusted by routing strategy. Read the live [method pricing catalog](https://lasso.sh/api/v1/agent/pricing) and applicable response headers. |
...
| Paid session | Deployment-dependent method pricing. Production currently disables this path; check [service discovery](https://lasso.sh/agent.json). |
