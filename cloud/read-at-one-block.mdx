...
Choose **Local** or **Global** under **Block continuity** in your custom
profile's chain settings to protect later block choices within that mode's scope. See
[Block continuity](/cloud/block-continuity) for the scope and freshness bound.
