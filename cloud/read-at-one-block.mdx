...
Enable **Block continuity** in your custom profile's chain settings to also
keep later block choices from returning a lower height. See
...
block executed. See [routing evidence](/cloud/observability#opt-in-metadata).
