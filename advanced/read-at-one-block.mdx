...
Lasso server, enable [Block regression protection](/advanced/block-continuity).
...
preserving the JSON-RPC body. See [routing metadata](/observability/request-metadata).
