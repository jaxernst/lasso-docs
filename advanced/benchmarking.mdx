...
In **Lasso RPC Core v0.4.3**, request execution supplies performance observations
...
**Load balanced** shuffles channels in released v0.4.3; it does not rank by a
benchmark score. **Priority** uses configured order. All strategies then apply
...
[BenchmarkStore source](https://github.com/jaxernst/lasso-rpc/blob/v0.4.3/lib/lasso/core/benchmarking/benchmark_store.ex).
...
it is not v0.4.3 hosted capacity or an SLA. [Versions and evidence](/releases-and-availability)
...
and [routing evidence](https://github.com/jaxernst/lasso-rpc/blob/v0.4.3/lib/lasso/core/routing_evidence.ex).
