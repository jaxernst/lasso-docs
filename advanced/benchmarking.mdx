...
In **Lasso RPC Core v0.4.5**, request execution supplies performance observations
...
[BenchmarkStore source](https://github.com/jaxernst/lasso-rpc/blob/v0.4.5/lib/lasso/core/benchmarking/benchmark_store.ex).
...
it is not v0.4.5 hosted capacity or an SLA. [Versions and evidence](/releases-and-availability)
...
and [routing evidence](https://github.com/jaxernst/lasso-rpc/blob/v0.4.5/lib/lasso/core/routing_evidence.ex).
