...
description: Use global block choices and hash-pinned reads with RPC Core.
---
...
[configuring the publication journal and serving fleet](/deployment/block-continuity). Choose a
...
[Coordinated disabling](/deployment/block-continuity#changing-or-disabling-the-policy) suspends
