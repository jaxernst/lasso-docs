...
description: Protect latest-block responses with automatic peer sharing.
---
...
For the separate durable `global` contract, see [fleet operations](/deployment/block-continuity).
