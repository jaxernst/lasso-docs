...
description: Operate and qualify bounded subscription recovery in RPC Core v0.4.3.
---

Lasso RPC Core v0.4.3 multiplexes matching `newHeads` and `logs` streams and
...
Use the [v0.4.3 configuration reference](https://github.com/jaxernst/lasso-rpc/blob/v0.4.3/docs/CONFIGURATION.md)
for supported configuration keys. The released
[stream coordinator](https://github.com/jaxernst/lasso-rpc/blob/v0.4.3/lib/lasso/core/streaming/stream_coordinator.ex)
...
In v0.4.3, buffered orphan-log additions and removals drain in their original
