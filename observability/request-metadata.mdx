...
description: 'Released Core v0.4.5 routing fields and reproducible response examples'
---

This page describes **Lasso RPC Core v0.4.5** metadata. It is opt-in and describes
...
The released [metadata builder](https://github.com/jaxernst/lasso-rpc/blob/v0.4.5/lib/lasso/observability/observability.ex)
...
[request context](https://github.com/jaxernst/lasso-rpc/blob/v0.4.5/lib/lasso/core/request/request_context.ex).
...
helpers, which are unchanged in v0.4.5. Provider identities and timings are fixed
