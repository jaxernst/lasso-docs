...
Lasso RPC Core v0.4.3 runs on your infrastructure. For a managed endpoint, use the [Lasso Cloud quickstart](/cloud/quickstart).

## Container installation

See [release evidence](/releases-and-availability) for the v0.4.3 image digest
